    ...
    with open(fname, "r") as csvfile:
        ...
        for line_index, line in enumerate(contents):
            if line_index == 0:
                ...
                # admissions
                is_open_admitted_code = line[keys.index("OPENADMP")]
                is_open_admissions = True if is_open_admitted_code == "1" else False
                undergrad_application_fee = line[keys.index('APPLFEEU')]
                ...
                dicts[ipeds_unitid]['general']['admissions'] = {
                    'undergrad_application_fee': undergrad_application_fee
                }
    ...
    with open(fname, "r") as csvfile:
        ...
        for line_index, line in enumerate(contents):
            if line_index == 0:
                ...
                dicts[ipeds_unitid]["general"]["students"]['headcount'] = {
                    'total_men': total_men,
    ...
    with open(fname, 'r') as csvfile:
        ...
        for line_index, line in enumerate(contents):
            if line_index == 0:
                ...
                admitted_men = get(line, 'ADMSSNM')
                admitted_women = get(line, 'ADMSSNW')
                admitted_total = get(line, 'ADMSSN')
                enrolled_men = get(line, 'ENRLFT')
                enrolled_women = get(line, 'ENRLFTM')
                enrolled_total = get(line, 'ENRLFTW')
                ...
                dicts[ipeds_unitid]['general']['admissions']['population'] = {
                    ...
                    'admitted_men': admitted_men,
                    'admitted_women': admitted_women,
                    'admitted_total': admitted_total,
                    'enrolled_men': enrolled_men,
                    'enrolled_women': enrolled_women,
    ...
    with open(fname, 'r') as csvfile:
        ...
        for line_index, line in enumerate(contents):
            if line_index == 0:
                ...
                if current_ipeds_unitid != ipeds_unitid:
                    # general - faculty
                    ...
                    current_ipeds_unitid = ipeds_unitid
                else:
                    pass
    return dicts
